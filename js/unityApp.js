const unityApp = {
    ...
    startLoading: function () {
        ...
        const buildUrl = "/gameH/war_the_knights/Build";
        const loaderUrl = buildUrl + "/war-the-knights-battle-arena-swords-3d[2]-mirraSDK[4.3.41].loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/war-the-knights-battle-arena-swords-3d[2]-mirraSDK[4.3.41].data.unityweb",
            frameworkUrl: buildUrl + "/war-the-knights-battle-arena-swords-3d[2]-mirraSDK[4.3.41].framework.js.unityweb",
            codeUrl: buildUrl + "/war-the-knights-battle-arena-swords-3d[2]-mirraSDK[4.3.41].wasm.unityweb",
